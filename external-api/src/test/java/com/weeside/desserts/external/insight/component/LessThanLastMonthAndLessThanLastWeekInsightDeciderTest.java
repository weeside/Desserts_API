...
class LessThanLastMonthAndLessThanLastWeekInsightDeciderTest {

    private LessThanLastMonthAndLessThanLastWeekInsightDecider dut;

    @BeforeEach
    void setUp() {
        dut = new LessThanLastMonthAndLessThanLastWeekInsightDecider();
    }
    ...
    private static Stream<Arguments> decide() {
        return Stream.of(
                ...
                Arguments.of(4.9, 5.0, 5.0, 4.9, null),
                Arguments.of(5.0, 4.9, 4.9, 5.0, null),
