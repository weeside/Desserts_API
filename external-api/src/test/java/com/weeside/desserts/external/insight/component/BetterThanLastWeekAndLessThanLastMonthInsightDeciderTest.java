...
class BetterThanLastWeekAndLessThanLastMonthInsightDeciderTest {

    private BetterThanLastWeekAndLessThanLastMonthInsightDecider dut;

    @BeforeEach
    void setUp() {
        dut = new BetterThanLastWeekAndLessThanLastMonthInsightDecider();
    }
