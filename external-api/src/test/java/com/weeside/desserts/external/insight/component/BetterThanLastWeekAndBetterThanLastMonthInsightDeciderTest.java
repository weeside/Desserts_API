...
class BetterThanLastWeekAndBetterThanLastMonthInsightDeciderTest {

    private BetterThanLastWeekAndBetterThanLastMonthInsightDecider dut;

    @BeforeEach
    void setUp() {
        dut = new BetterThanLastWeekAndBetterThanLastMonthInsightDecider();
    }
